...
var _View_SigninComponent0 = (function (_super) {
    ...
    _View_SigninComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_11 = this.renderer.createText(this._el_2, '  ', null);
...
export function viewFactory_SigninComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SigninComponent === null)) {
        (renderType_SigninComponent = viewUtils.createRenderComponentType('D:/webdesign/Messenger-Angular2-Nodejs-/assets/app/auth/signin.component.html', 0, import10.ViewEncapsulation.None, styles_SigninComponent, {}));
    }
