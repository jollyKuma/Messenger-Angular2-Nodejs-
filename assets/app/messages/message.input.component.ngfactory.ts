...
export function viewFactory_MessageInputComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MessageInputComponent> {
  if ((renderType_MessageInputComponent === (null as any))) { (renderType_MessageInputComponent = viewUtils.createRenderComponentType('D:/webdesign/Messenger-Angular2-Nodejs-/assets/app/messages/message.input.component.html',0,import9.ViewEncapsulation.None,styles_MessageInputComponent,{})); }
